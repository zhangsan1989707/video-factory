...
STYLE_PROFILES: dict[str, dict[str, str]] = {
    ...
    "apple_minimal": {
        ...
        "bg_panel": "#f0f0f2",
        "accent_cyan": "#378ADD",
        "accent_cyan_rgb": "55, 138, 221",
        "accent_blue": "#3395ff",
        "accent_blue_rgb": "51, 149, 255",
        "accent_purple": "#378ADD",
        "accent_purple_rgb": "55, 138, 221",
        "accent_green": "#34c759",
    ...
    "claude_warm": {
        ...
        "show_orbit_rings": "1",
        "show_glow_orbs": "1",
        "stat_chip_bg": "rgba(255,255,255,0.06)",
        "stat_chip_border": "1px solid rgba(255,255,255,0.1)",
        "stat_chip_radius": "18px",
        "stat_chip_shadow": "none",
        "metric_card_bg": "rgba(255,255,255,0.04)",
        "metric_card_border": "1px solid rgba(255,255,255,0.08)",
        "metric_card_radius": "16px",
        "reason_border_radius": "16px",
        "hook_card_bg": "rgba(255,255,255,0.04)",
        "hook_card_border": "1px solid rgba(255,255,255,0.08)",
        "hook_card_radius": "18px",
    },
    "sspai_editorial": {
        "canvas_bg": "#faf9f7",
    ...
    "bytedance_product": {
        ...
        "bg_panel": "#f0f2f5",
        "accent_cyan": "#3D7EFF",
        "accent_cyan_rgb": "61, 126, 255",
        "accent_blue": "#3D7EFF",
        "accent_blue_rgb": "61, 126, 255",
